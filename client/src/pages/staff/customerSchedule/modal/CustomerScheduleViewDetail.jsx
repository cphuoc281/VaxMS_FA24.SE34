...
export const CustomerScheduleViewDetail = () => {
    ...
    const columns = [{
        ...
        {
            title: "Thanh toán", dataIndex: "payStatus", key: "payStatus", align: "center", render: (_, record) => {
                return (<div>{record?.payStatus ? "Đã thanh toán" : "Chưa thanh toán"}</div>);
            },
        }, {
    ...
    const statusOptions = [{label: "Tất cả", value: ""}, {
        label: "Chờ duyệt",
        value: "pending"
    }, {label: "Đã duyêt", value: "confirmed"}, {label: "Từ chối", value: "cancelled"},];
